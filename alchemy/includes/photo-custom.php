...
function photo_format() {
	...
	$labels = array(
		...
		'edit_item'                  => __( 'Éditer le format', 'text_domain' ),
		'update_item'                => __( 'Mettre à jour', 'text_domain' ),
		'view_item'                  => __( 'View Item', 'text_domain' ),
		'separate_items_with_commas' => __( 'Separer les formats avec une virgule', 'text_domain' ),
		'add_or_remove_items'        => __( 'Ajouter ou retirer des formats', 'text_domain' ),
		'choose_from_most_used'      => __( 'Choisir parmi les plus utilisés', 'text_domain' ),
		'popular_items'              => __( 'Popular Items', 'text_domain' ),
		'search_items'               => __( 'Rechercher un format', 'text_domain' ),
		'not_found'                  => __( 'Not Found', 'text_domain' ),
...
function categories_photos() {
	...
	$labels = array(
		...
		'edit_item'                  => __( 'Éditer la catégorie', 'text_domain' ),
		'update_item'                => __( 'Mettre à jour', 'text_domain' ),
		'view_item'                  => __( 'View Item', 'text_domain' ),
		'separate_items_with_commas' => __( 'Separer les catégories avec une virgule', 'text_domain' ),
		'add_or_remove_items'        => __( 'Ajouter ou retirer des catégories photos', 'text_domain' ),
